...
vivekmasonaDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:#04C5B9;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span>Visite ❤️PAHILAGANA❤️For More Downloads <ul id='listurl'>";
...
vivekmasonaAudElem.style.height="98%";
